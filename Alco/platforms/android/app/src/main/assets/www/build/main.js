...
var HomePage = (function () {
    ...
    HomePage.prototype.startScanning = function () {
        this.bluetoothSerial.discoverUnpaired().catch(function (error) { return console.log(error); });
        this.bluetoothSerial.setDeviceDiscoveredListener().forEach(function (device) { return function (device) { console.log(device.id); }; });
    };
    HomePage = __decorate([
